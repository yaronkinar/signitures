...
// api-src/webhooks-lemonsqueezy.ts
var webhooks_lemonsqueezy_exports = {};
__export(webhooks_lemonsqueezy_exports, {
  config: () => config,
  default: () => handler
});
module.exports = __toCommonJS(webhooks_lemonsqueezy_exports);
...
// api-src/entitlements.ts
var defaultEntitlements = () => ({
  version: 1,
  pro: { active: false },
  unlockedSignatureIds: []
});
var entitlementsPath = (tenantId) => `entitlements/${tenantId}.json`;
var readEntitlements = async (tenantId) => {
  try {
    ...
    return {
      ...
      pro: {
        ...
        subscriptionId: typeof parsed.pro.subscriptionId === "string" ? parsed.pro.subscriptionId : void 0,
        renewsAt: typeof parsed.pro.renewsAt === "number" ? parsed.pro.renewsAt : void 0
      },
...
var writeEntitlements = async (tenantId, next) => {
...
// api-src/lemonsqueezy.ts
var import_node_crypto = require("node:crypto");
var verifyLemonSqueezySignature = (rawBody, signatureHeader, secret) => {
  ...
  return (0, import_node_crypto.timingSafeEqual)(expectedBuffer, actualBuffer);
};
    ...
    if (eventName === "subscription_created" || eventName === "subscription_payment_success") {
      ...
      await writeEntitlements(tenantId, {
        ...
        pro: {
          ...
          renewsAt: renewsAt ? Date.parse(renewsAt) : void 0
        }
      });
      res.status(200).json({ ok: true });
      return;
...
@vercel/blob/dist/chunk-3D2SZ6M2.js:
   ...
   *)
*/
const __exports = module.exports; const __handler = __exports.default ?? __exports; if (__handler !== __exports) { for (const __key of Object.keys(__exports)) { if (__key !== "default") __handler[__key] = __exports[__key]; } } module.exports = __handler;
