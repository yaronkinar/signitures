...
export const CHANGELOG_HE: ChangelogDay[] = [
  {
    ...
    version: '1.0.34',
    items: [
      'נוסף בורר גופן ובקרת גודל טקסט בראש המסך — אפשר להחליף את גופן הממשק (Rubik, Heebo, Assistant, Open Sans, Inter, Lexend) ולהגדיל או להקטין את הטקסט, וההעדפה נשמרת בדפדפן',
      'ערכת העיצוב "קלאסי" הפכה לברירת המחדל, עם גופן ממשק קריא יותר',
      'תיקון: חתימה בעברית שהועתקה והודבקה ל-Outlook הופיעה הפוך (מראה) — מבנה הטבלה עכשיו RTL ותואם את כיוון חלון הכתיבה, כך שהפריסה לא מתהפכת',
      'אחרי שינוי עיצוב לאחר העלאת Excel — מופיע באנר שמציע להחיל את העיצוב החדש על כל הרשומות, בלי להעלות מחדש',
      'רשומות החתימה מ-Excel נשמרות בדפדפן וממשיכות להופיע גם אחרי רענון',
      'אפשרות הצגה/הסתרה של תוויות פרטי הקשר (נייד:/דוא"ל:/אתר:)'
    ]
  },
  {
    date: '2026-06-02',
