...
const translations = {
  en: {
    ...
    navPreview: 'Preview',
    navPreviewShort: 'Preview',
    navAiShort: 'AI',
    navContactShort: 'Contact',
    navBulkShort: 'Bulk',
    navLogoShort: 'Logo',
    navSocialShort: 'Social',
    navLayoutShort: 'Layout',
    navPositionShort: 'Position',
    navColorsShort: 'Colors',
    navImagesShort: 'Images',
    navInstallShort: 'Install',
    ...
    uiFontGroupLabel: 'Interface font and size',
    uiFontLabel: 'Font',
    uiFontDefault: 'Default',
    uiFontSizeLabel: 'Text size',
    uiFontSizeIncrease: 'Increase text size',
    uiFontSizeDecrease: 'Decrease text size',
    langEnglish: 'English',
    ...
    socialIconVariantCircle: 'Circle',
    ...
    dividerSpacing: 'Divider spacing',
    ...
    downloadPngFailed: 'Could not download PNG. Generate the signature and try again.',
    ...
    previewGenerateFailed: 'Preview could not be updated. Try refreshing the page.',
    ...
    bulkDownloadPngZip: 'Download PNG ZIP',
    ...
    bulkPngSuccessOne: 'Downloaded signatures-png.zip with 1 PNG.',
    bulkPngSuccessMany: 'Downloaded signatures-png.zip with {count} PNGs.',
  ...
  he: {
    ...
    navPreview: 'תצוגה',
    navPreviewShort: 'תצוגה',
    navAiShort: 'AI',
    navContactShort: 'קשר',
    navBulkShort: 'כמות',
    navLogoShort: 'לוגו',
    navSocialShort: 'רשתות',
    navLayoutShort: 'פריסה',
    navPositionShort: 'מיקום',
    navColorsShort: 'צבעים',
    navImagesShort: 'תמונות',
    navInstallShort: 'התקנה',
    ...
    uiFontGroupLabel: 'גופן וגודל הממשק',
    uiFontLabel: 'גופן',
    uiFontDefault: 'ברירת מחדל',
    uiFontSizeLabel: 'גודל טקסט',
    uiFontSizeIncrease: 'הגדלת טקסט',
    uiFontSizeDecrease: 'הקטנת טקסט',
    langEnglish: 'English',
    langHebrew: 'עברית',
    fullName: 'שם מלא',
    ...
    downloadPngFailed: 'לא ניתן להוריד PNG. יש ליצור חתימה ולנסות שוב.',
    ...
    previewGenerateFailed: 'לא ניתן לעדכן את התצוגה המקדימה. נסו לרענן את הדף.',
    ...
    bulkDownloadPngZip: 'הורדת ZIP של PNG',
    ...
    bulkPngSuccessOne: 'הורד signatures-png.zip עם PNG אחד.',
    bulkPngSuccessMany: 'הורד signatures-png.zip עם {count} קבצי PNG.',
