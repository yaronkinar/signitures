...
const translations = {
  en: {
    ...
    aiApiKeyPlaceholder: 'sk-... (optional if set in .env)',
    aiApiKeyUsingEnv: 'Using API key from .env — leave empty to keep using it.',
    aiDesignButton: 'Design with AI',
    ...
    aiDesignMissingApiKey:
      'Add an OpenAI API key above, or set VITE_OPENAI_API_KEY in a .env file.',
    ...
    alertOutlookInstallSuccess:
      'Downloaded install-outlook-signature.bat. Double-click it to install (no separate PowerShell file needed). If Windows asks, choose Run anyway.',
  ...
  he: {
    ...
    alertOutlookInstallSuccess:
      'הורד install-outlook-signature.bat. לחצו פעמיים על הקובץ להתקנה (אין צורך בקובץ PowerShell נפרד). אם Windows שואל, בחרו "הפעל בכל זאת".',
